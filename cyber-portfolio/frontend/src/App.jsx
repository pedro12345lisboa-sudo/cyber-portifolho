    ...
    <>
      <header className="hero">
        <div className="wrap">
          ...
          <div className="links">
            {perfil?.github && <a className="link-btn" href={perfil.github} target="_blank" rel="noreferrer">GitHub</a>}
            {perfil?.linkedin && <a className="link-btn" href={perfil.linkedin} target="_blank" rel="noreferrer">LinkedIn</a>}
            {perfil?.instagram && <a className="link-btn" href={perfil.instagram} target="_blank" rel="noreferrer">Instagram</a>}
          </div>
        </div>
      </header>
              ...
              {skills
                ...
                .map((s) => (
                  <div className="skill-row" key={s.id}>
                    ...
                    <span className={`skill-status ${s.status === 'aprendendo' ? 'aprendendo' : ''}`}>
